# -*- coding: utf-8 -*-
"""Build BRD_User_Management_v4.3.docx — FR-53 additional charge replaces (not unions) assigned-post privileges;
officer switches back to assigned post without logout to regain SR privileges."""
...
DST = BASE / "BRD_User_Management_v4.3.docx"
...
def build() -> Document:
    ...
    core.title = "BRD — User Management Module (KAVERI 3.0) v4.3"
