...
| ID | Title | Link |
|----|--------|------|
| BRD-K3-UM-001 | This document | Finalized BRD/User Management/BRD_User_Management_v1.2.docx |
...
This document presents a comprehensive assessment of departmental **User Management** for Kaveri 3.0. It is based on department-stated administration needs, ServiceDesk evidence of live operational failures, and the Phase 1 programme mandate that User Management cover **login, roles, office mapping, transfer, relieving and access rights**.
...
- Seed and maintain the departmental roles required by Marriage Phase 1 (SR, DEO, FDA, SDA, DR, IGR and related) so Marriage Online / Offline access rights can be enforced from this module.
...
|--------|----------|------|----------|--------|
| DEC-UM-001 | Phase 1 User Management = central departmental login, role and office control used by all modules | Programme plan v0.4 | Steering / PO | This BRD scope |
