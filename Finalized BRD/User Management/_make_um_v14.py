# -*- coding: utf-8 -*-
"""Convert BRD_User_Management_v1.4 markdown to styled .docx matching Marriage BRD look."""
...
SRC = BASE / "BRD_User_Management_v1.4.md"
DST = BASE / "BRD_User_Management_v1.4.docx"
...
def convert(md_text: str) -> Document:
    ...
    header.paragraphs[0].text = (
        "KAVERI 2.0  |  BRD — User Management & RBAC  |  BRD-K2-UM-001"
    )
...
def main() -> None:
    ...
    core.title = "BRD — User Management & RBAC Module (KAVERI 2.0)"
    core.author = "Nandha Kumar"
    core.subject = "BRD-K2-UM-001"
    target = DST
    try:
        doc.save(target)
