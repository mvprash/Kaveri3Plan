# -*- coding: utf-8 -*-
"""Build BRD_User_Management_v2.5.docx — Document Registration without online/offline split."""
...
DST = BASE / "BRD_User_Management_v2.5.docx"
...
def build() -> Document:
    ...
    scope_in = {
        ...
        20: "Module Master and Role-to-Module mapping (Registration of Documents, Marriage Registration, Encumbrance Search, Certified Copy, and other modules)",
    ...
    for p in doc.paragraphs:
        if p.text.strip() == "Enforce role-based access control to protect sensitive data and functionality.":
            insert_paragraph_after(
                p,
                "Support Module Master and Role-to-Module mapping so organisational roles gain access to Registration of Documents, Marriage Registration, Encumbrance Search, Certified Copy, and other modules.",
                "List Paragraph",
            )
            break
    ...
    note6 = insert_paragraph_after(
        ...
        "Application capabilities such as Registration of Documents, Marriage Registration, Encumbrance "
        "Search, and Certified Copy are maintained in a Module Master and mapped to roles. Registration "
        "of Documents is treated as a single module (no online/offline classification). A user gains "
        "module access only through the Role-to-Module mappings of the role(s) assigned to them.",
        "Normal",
    )
    ...
    mod_tbl = insert_table_after(
        ...
        [
            ("Registration of Documents", "Registration of documents", "Citizen applicants; DSR SRO staff; Other Department verifiers"),
            ("Marriage Registration", "Marriage registration (Hindu Marriage and Special Marriage)", "Citizen applicants; DSR SRO / DEO / SR"),
    ...
    map_tbl = insert_table_after(
        ...
        [
            ("Citizen", "Citizen", "Registration of Documents; Marriage Registration; Encumbrance Search; Certified Copy; Stamp Duty / Payments", "Apply, view own applications, pay, download"),
            ("Marriage Applicant", "Citizen", "Marriage Registration", "Apply, upload documents, track status"),
            ("Document Registration Applicant", "Citizen", "Registration of Documents", "Apply, track, pay"),
            ("Certified Copy / EC Applicant", "Citizen", "Encumbrance Search; Certified Copy", "Apply, pay, download"),
            ("Sub-Registrar (SR)", "DSR", "Registration of Documents; Marriage Registration; Encumbrance Search; Certified Copy", "View, approve, sign, print"),
            ("DEO", "DSR", "Registration of Documents; Marriage Registration", "Add, edit, scan, view"),
            ("FDA", "DSR", "Registration of Documents; Certified Copy; Encumbrance Search", "View, add, edit, print"),
            ("SDA", "DSR", "Registration of Documents; Encumbrance Search", "View, add, print"),
            ("DRO", "DSR", "Registration of Documents; Marriage Registration; MIS / Dashboards", "View, approve (district span), MIS"),
            ("Revenue Verification Officer", "Other Department", "Registration of Documents", "View, verify revenue particulars"),
            ("Treasury Payment Verifier", "Other Department", "Stamp Duty / Payments", "View, verify payment status"),
            ("Police Enquiry Officer", "Other Department", "Registration of Documents; Certified Copy", "View, respond to enquiry"),
    ...
    core.title = "BRD — User Management Module (KAVERI 3.0) v2.5"
