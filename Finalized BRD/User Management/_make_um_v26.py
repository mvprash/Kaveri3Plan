# -*- coding: utf-8 -*-
"""Build BRD_User_Management_v2.6.docx — Module Function, Resource (API/URL), enforcement."""
...
DST = BASE / "BRD_User_Management_v2.6.docx"
...
def build() -> Document:
    ...
    replace_paragraph_text(
        ...
        "Resource (API/URL) masters, runtime access enforcement, and dedicated user-creation "
    ...
    replace_paragraph_text(
        ...
        "are not named after modules. Application Admin maintains these masters. Password management "
    ...
    core.title = "BRD — User Management Module (KAVERI 3.0) v2.6"
