# -*- coding: utf-8 -*-
"""Build BRD_User_Management_v2.7.docx — DSR Officer Hierarchy Master (§6.5.7)."""
...
DST = BASE / "BRD_User_Management_v2.7.docx"
...
def build() -> Document:
    ...
    scope_in = {
        ...
        22: "Sanctioned posts master and Primary/Secondary role assignment for DSR Officers; single role for Other Department users with optional account end date",
    ...
    core.title = "BRD — User Management Module (KAVERI 3.0) v2.7"
