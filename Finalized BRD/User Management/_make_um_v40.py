# -*- coding: utf-8 -*-
"""Build BRD_User_Management_v4.0.docx — Transfer In: order + joining date; vacant post only; login from 12:00 AM joining date."""
...
DST = BASE / "BRD_User_Management_v4.0.docx"
...
def build() -> Document:
    ...
    scope_in = {
        ...
        22: "Transfer Out / Relieving and Transfer In (vacant post only; Transfer/Reporting Order + Joining Date; login from 12:00 AM on Joining Date); office span via Office Hierarchy",
    ...
    replace_table_rows(
        ...
        [
            ...
            (
                ...
                "(including after relieving under FR-58). Transfer In assignments shall also require a "
                "vacant post (FR-60).",
                "High",
            ),
            (
            ...
            (
                ...
                "assign an officer to a vacant sanctioned post (Post + Office). The system shall allow "
                "Transfer In only to a post that is vacant at that office (Occupied < Sanctioned "
                "Strength). While processing Transfer In, the system shall capture Transfer Order / "
    ...
    replace_table_rows(
        ...
        [
            ...
            ("Unauthorised relieving / transfer in", "High", "Scope to offices under actor (FR-59); vacant post only for Transfer In (FR-60); post parentage (FR-43)."),
    ...
    replace_table_rows(
        ...
        [
            ...
            ("Transfer In", "Process by which a superior assigns a DSR Officer to a vacant post within office span, capturing Transfer/Reporting Order and Joining Date (FR-60); login allowed from 12:00 AM on Joining Date (FR-61)"),
    ...
    transfer_in_note = insert_paragraph_after(
        transfer_in_sub,
        "Transfer In assigns a DSR Officer to a vacant post within the superior's office span "
        "(same Office Hierarchy scoping as Transfer Out — FR-59). The system shall capture "
        "Transfer Order / Reporting Order and Joining Date (FR-60). Only vacant posts are selectable. "
    ...
    transfer_in_ex = insert_paragraph_after(
        ...
        "DRO Bengaluru, selects vacant Sub-Registrar at SRO Yeshwanthapura, enters Transfer/Reporting "
    ...
    insert_table_after(
        ...
        [
            ...
            ("3", "Select target vacant Post + Office (only vacant shown/selectable)", "Superior", "Blocked if not vacant (FR-45, FR-60)"),
    ...
    core.title = "BRD — User Management Module (KAVERI 3.0) v4.0"
