# -*- coding: utf-8 -*-
"""Build BRD_User_Management_v2.3.docx — §6.5.4 lists Citizen, Other Department, and DSR roles."""
...
DST = BASE / "BRD_User_Management_v2.3.docx"
...
def build() -> Document:
    ...
    core.title = "BRD — User Management Module (KAVERI 3.0) v2.3"
