# -*- coding: utf-8 -*-
"""Build BRD_User_Management_v3.0.docx — remove Primary/Secondary; assign posts only."""
...
DST = BASE / "BRD_User_Management_v3.0.docx"
...
def build() -> Document:
    ...
    replace_paragraph_text(
        ...
        "(roles via Post–Role mapping; no Primary/Secondary assignment), single-role assignment "
    ...
    replace_paragraph_text(
        ...
        "sanctioned posts with no Primary/Secondary distinction. Other Department users are assigned "
    ...
    replace_table_rows(
        ...
        [
            ...
            (
                ...
                "Primary/Secondary role or post distinction. Effective roles shall be the union of all "
                "roles mapped to the assigned posts via Post–Role mapping.",
                "High",
            ),
            (
                "FR-28",
            ...
            (
                ...
                "roles currently held by that user (for DSR Officers: roles derived from all active "
                "post occupancies via Post–Role mapping; for Other Department users: the single assigned "
    ...
    replace_table_rows(
        ...
        [
            ...
            ("Post occupancy", "Assignment of a DSR user to a sanctioned post at an office; roles follow from Post–Role mapping for all active occupancies; no Primary/Secondary distinction"),
    ...
    primary_note = insert_paragraph_after(
        ...
        "Posts Master). There is no Primary or Secondary role/post assignment. Effective roles = "
        "union of all roles mapped to those posts (Post–Role mapping; one post may map to multiple "
        "roles). Other Department users and Citizens use Role Master directly (see Sections 6.5.1, "
        "6.5.4 and 6.6.2).",
        "Normal",
    )
    primary_tbl = insert_table_after(
        primary_note,
        ["User Category", "What is assigned", "Roles granted", "End Date", "Notes"],
        [
            (
                "DSR Officer",
                "One or more vacant sanctioned posts (Post + Office)",
                "Union of roles from Post–Role mapping for all active posts",
                "Optional per post occupancy",
                "At least one post required; no Primary/Secondary",
            ),
            (
                "Other Department",
    ...
    enf_tbl = insert_table_after(
        ...
        [
            ...
            ("2", "Load assigned role(s) for the user from User Master", "Auth / UM service", "DSR: roles from active post occupancies via Post–Role map; Other Department: one role"),
    ...
    wf_intro = insert_paragraph_after(
        ...
        "no Primary/Secondary). For Other Department users, select exactly one role.",
        "Normal",
    )
    ...
    dsr_tbl = insert_table_after(
        ...
        [
            ...
            ("5", "System resolves effective roles via Post–Role mapping for all assigned posts", "System", "FR-47; one post may yield multiple roles"),
    ...
    core.title = "BRD — User Management Module (KAVERI 3.0) v3.0"
