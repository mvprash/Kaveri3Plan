# -*- coding: utf-8 -*-
"""Build BRD_User_Management_v4.6.docx — Division Master, Post–Office-Type validation,
Karnataka e-Gov NFRs, expanded reporting; items 15–23 per stakeholder decisions."""
...
DST = BASE / "BRD_User_Management_v4.6.docx"
...
def build() -> Document:
    ...
    for p in doc.paragraphs:
        if p.text.strip() == "The system shall provide a report of role and permission assignments across all users.":
            ...
            insert_paragraph_after(
                posting_note,
                "The system shall provide a Citizen lost-mobile / security-question recovery report "
                "(FR-56) over a selected date range showing each recovery attempt — Username, questions "
                "presented, PIN dispatch outcome, new mobile OTP outcome, success/failure, and timestamp.",
                "List Paragraph",
            )
            break
    ...
    core.title = "BRD — User Management Module (KAVERI 3.0) v4.6"
