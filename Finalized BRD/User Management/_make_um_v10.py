# -*- coding: utf-8 -*-
"""Convert BRD_User_Management markdown to styled .docx matching Marriage BRD look."""
...
BASE = Path(r"E:\Prashanth\Official\Kaveri 3.0\Kaveri3Plan\Finalized BRD\User Management")
SRC = BASE / "BRD_User_Management_v1.3.md"
DST = BASE / "BRD_User_Management_v1.3.docx"
...
def convert(md_text: str) -> Document:
    ...
    header.paragraphs[0].text = "Kaveri 3.0  |  BRD — User Management Module  |  BRD-K3-UM-001"
    ...
    r = fp.add_run("Department of Stamps & Registration, Government of Karnataka  |  Page ")
    r.font.size = Pt(8)
    r.font.color.rgb = RGBColor(0x66, 0x66, 0x66)
    add_page_number(fp)
    r2 = fp.add_run("  |  Draft v1.3")
    r2.font.size = Pt(8)
...
def main() -> None:
    ...
    core.title = "BRD — User Management Module (Kaveri 3.0)"
