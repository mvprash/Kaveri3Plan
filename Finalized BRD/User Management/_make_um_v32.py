# -*- coding: utf-8 -*-
"""Build BRD_User_Management_v3.2.docx — Role–Module mapping integrity, App Admin Option B, FR-31 note."""
...
DST = BASE / "BRD_User_Management_v3.2.docx"
...
def build() -> Document:
    ...
    replace_table_rows(
        ...
        [
            ...
            (
                ...
                "function; otherwise deny (HTTP 403) and audit the attempt. Application Admin system "
                "principals are authorised for FN-UM-ADMIN outside Role–Module–Function mapping (FR-51).",
                "High",
            ),
            (
                "FR-50",
    ...
    note3 = insert_paragraph_after(
        ...
        "DSR Officers are assigned vacant sanctioned posts; effective roles are the union of roles mapped "
        "to those posts. Over-capacity assignment is blocked (FR-45–FR-49).",
        "Normal",
    )
    ...
    primary_note = insert_paragraph_after(
        ...
        "union of all roles mapped to those posts (Post–Role mapping). Division-specific posts "
    ...
    core.title = "BRD — User Management Module (KAVERI 3.0) v3.2"
