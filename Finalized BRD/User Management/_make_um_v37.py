# -*- coding: utf-8 -*-
"""Build BRD_User_Management_v3.7.docx — email-as-username login; OTP to mobile only; security Q for lost mobile."""
...
DST = BASE / "BRD_User_Management_v3.7.docx"
...
def build() -> Document:
    ...
    core.title = "BRD — User Management Module (KAVERI 3.0) v3.7"
