# -*- coding: utf-8 -*-
"""Build BRD_User_Management_v3.6.docx — show session Post+Role after login; FR-53 Role+Post dropdown."""
...
DST = BASE / "BRD_User_Management_v3.6.docx"
...
def build() -> Document:
    ...
    scope_in = {
        ...
        18: "OTP-based authentication; multi-post DSR login selection; FR-53 Role+Post drop-down for vacant subordinates during login only; FR-54 display logged-in Post with mapped Role after login",
    ...
    core.title = "BRD — User Management Module (KAVERI 3.0) v3.6"
