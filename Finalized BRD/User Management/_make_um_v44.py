# -*- coding: utf-8 -*-
"""Build BRD_User_Management_v4.4.docx — FR-57 office-span examples narrowed to immediate-parent;
future-dated Transfer In reserves capacity when relieving is recorded; midnight occupancy job."""
...
DST = BASE / "BRD_User_Management_v4.4.docx"
...
def build() -> Document:
    ...
    replace_table_rows(
        ...
        [
            ...
            (
                ...
                "charge post or cleared, office, timestamp).",
                "High",
            ),
            (
                "FR-54",
                "After login, the home page and/or application header shall display the assigned Post "
                "(from FR-52) with its mapped Role(s) and Office details. When additional charge is "
                "active under FR-53, the header shall show which context is currently driving session "
                "privileges — either assigned post only, or additional charge post (with assigned post "
                "still shown for reference but not active for access). Example with additional charge "
                "active: \"Assigned: Sub-Registrar (SR) — SRO Yeshwanthapura | Active context: "
                "Additional charge — FDA (Enforcement)\". The officer may switch between assigned-post "
    ...
    replace_table_rows(
        ...
        [
            ...
            (
                ...
                "FR-60, FR-61, and FR-67. Occupancy de-allocation, reserved Transfer In becoming "
                "active, and Sanctioned Posts occupied-count updates shall be applied by the occupancy "
                "refresh job (FR-68).",
                "High",
            ),
            (
            ...
            (
                ...
                "de-allocate / remove the mapping of the user to the relieved post after 11:59 PM of "
            ...
            (
                ...
                "user shall be allowed to log in and use that post only from 12:00 AM (start) of the "
                "Joining Date onwards. Before 12:00 AM of the Joining Date, login for that post occupancy "
            ...
            (
                "FR-68",
                "The system shall run a scheduled occupancy refresh job shortly after midnight each "
                "calendar day (after 12:00 AM). On each run the job shall: (1) de-allocate user–post "
            ...
            (
                ...
                "FR-38; for each API/URL request look up the Resource Master "
    ...
    replace_table_rows(
        ...
        [
            ...
            ("Occupancy refresh job", "Scheduled job shortly after midnight that de-allocates relieved and ended occupancies, activates reserved Transfer In occupancies whose Joining Date is today, recalculates Sanctioned Posts occupied counts, and refreshes officers' effective post assignments for login (FR-68)"),
    ...
    switch_ex_tbl = insert_table_after(
        ...
        [
            ...
            (
                ...
                "Active context: Additional charge DEO; switch back for SR privileges (FR-54)",
            ),
        ],
    )
    ...
    display_note = insert_paragraph_after(
        ...
        "charge: \"Assigned: Sub-Registrar (SR) | SRO Yeshwanthapura\". Example with additional charge "
        "active: \"Assigned: Sub-Registrar (SR) | SRO Yeshwanthapura | Active context: Additional "
        "charge — FDA (Enforcement)\". The officer opens the additional-charge control from here "
        "without logging out.",
        "Normal",
    )
    ...
    dsr_tbl = insert_table_after(
        ...
        [
            ...
            ("4", "Optionally set End Date per post occupancy", "Admin", "If set, occupancy freed on that date by the occupancy refresh job; FR-30, FR-68"),
    ...
    core.title = "BRD — User Management Module (KAVERI 3.0) v4.4"
