# -*- coding: utf-8 -*-
"""Build BRD_User_Management_v4.7.docx — Division Code in role catalogue; FR-46 Division Code;
FR-17 / login-label / IST polish; merged §8 recovery report; FR-53 same-office example."""
...
DST = BASE / "BRD_User_Management_v4.7.docx"
...
def build() -> Document:
    ...
    replace_table_rows(
        ...
        [
            ...
            (
                ...
                "Master — Head Office, District Registrar Office, Sub-Registrar Office). When creating "
                "or updating a Sanctioned Posts row or assigning a post to an officer, the system shall "
                "reject combinations not permitted by this mapping (FR-24, FR-48). Example: POST-SR, "
                "POST-FDA-ENF, POST-SDA-ENF, and POST-DEO are allowed only at Sub-Registrar Office; "
                "POST-DRO only at District Registrar Office; POST-DIGR-* and POST-IGR only at Head "
                "Office. Application Admin shall maintain the mapping with audit trail; Domain Expert "
                "shall validate the full matrix before go-live.",
                "High",
            ),
            (
                "FR-46",
    ...
    posts_tbl = insert_table_after(
        ...
        [
            ...
            ("POST-SR-COMP", "Sub Registrar (Comp)", "DIV-COMPUTERS", "Active"),
    ...
    post_office_intro = insert_heading_after(
        sanc_tbl,
        "Post–Office-Type Allowed mapping — example rows (FR-78; Domain Expert to complete):",
        "Normal",
        parent=rbac_parent,
    )
    post_office_tbl = insert_table_after(
        post_office_intro,
        ["Post Code (or pattern)", "Allowed Office Type(s)", "Notes"],
        [
            ("POST-IGR", "Head Office", "Top management"),
            ("POST-DIGR-*", "Head Office", "All DIGR division heads"),
            ("POST-AIGR-*", "Head Office", "Assistant IGR posts"),
            ("POST-HQA-ADMIN", "Head Office", "Admin division HQ posts"),
    ...
    core.title = "BRD — User Management Module (KAVERI 3.0) v4.7"
