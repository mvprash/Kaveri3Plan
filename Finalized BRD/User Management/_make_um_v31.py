# -*- coding: utf-8 -*-
"""Build BRD_User_Management_v3.1.docx — fix post/role/hierarchy conflicts (unique posts & roles)."""
...
DST = BASE / "BRD_User_Management_v3.1.docx"
...
def build() -> Document:
    ...
    core.title = "BRD — User Management Module (KAVERI 3.0) v3.1"
