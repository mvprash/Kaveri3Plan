# -*- coding: utf-8 -*-
"""Convert LLD_Hindu_Marriage_Online_v1.0.md to Word .docx."""
...
BASE = Path(r"E:\Prashanth\Official\Kaveri 3.0\Kaveri3Plan\\LLD")
SRC = BASE / "LLD_Hindu_Marriage_Online_v1.0.md"
DST = BASE / "LLD_Hindu_Marriage_Online_v1.0.docx"
...
def main() -> None:
    ...
    try:
        ...
        target = DST.with_name(DST.stem + "_new" + DST.suffix)
        doc.save(target)
        print("ORIGINAL LOCKED (open in Word) â€” saved instead as:")
