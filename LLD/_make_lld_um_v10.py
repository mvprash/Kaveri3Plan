# -*- coding: utf-8 -*-
"""Convert LLD_User_Management_v1.0.md to Word .docx."""
...
SRC = BASE / "LLD_User_Management_v1.0.md"
DST = BASE / "LLD_User_Management_v1.0.docx"
...
def main() -> None:
    ...
    try:
        ...
        doc.save(target)
        print("ORIGINAL LOCKED — saved instead as:")
